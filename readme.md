...
|    Risk management    | Повышающий целостность | Имплементация управления рисками со стороны терминала, проверка PIN, все взаимодействия с ПС через Authentication | Проверки связанные с оценкой рисков и проверкой владельца карты                                                                                                |
